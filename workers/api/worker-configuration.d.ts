/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/api/wrangler.jsonc --env=production workers/api/worker-configuration.d.ts` (hash: 4ae0605adeaabeec56e72bc425e29e52)
