/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/api/wrangler.jsonc --env=production workers/api/worker-configuration.d.ts` (hash: f042fcdfd749cf75ea73a7009255f341)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	OPENROUTER: SecretsStoreSecret;
	AI: Ai;
	ENVIRONMENT: "production";
	ACCESS_TEAM_DOMAIN: "broad-dust-cbb8.cloudflareaccess.com";
	ACCESS_AUD: "879e0ff05032eabf36bad8ea8db6d6e74085a992c003749ecdb682b62c445f82";
	TURNSTILE_HOSTNAMES: "marlonavery.com,www.marlonavery.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "TURNSTILE_HOSTNAMES">> {}
}
