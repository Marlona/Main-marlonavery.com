/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/web/wrangler.jsonc --env=production workers/web/worker-configuration.d.ts` (hash: 2182040f9e04a9a857fea7569d9c0c8e)
// Runtime types generated with workerd@1.20260820.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_MEDIA: R2Bucket;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	API: Fetcher /* maverick-api */;
}
